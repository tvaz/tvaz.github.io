...
---
One feature that I really like on Windows is the wallpaper slideshow- by simply configuring a directory, I could have each monitor in my desktop setup rotate through all my favorite wallpapers.
...
I use Cinnamon desktop, which does allow a configurable slideshow, but I am locked in to one wallpaper on both monitors. Variety, Nitrogen and HydraPaper seemed to be popular options, but I ruled them all out for not supporting the dual-monitor setup I wanted.
...
I also wanted to track the changes in a log, so I am going to be using my `~/logs` directory. You can put your log file wherever you like, or remove the logging altogether. In addition, I wanted to send a notification each time the script executed.
...
I will keep diving into more interesting customizations for Linux and application setups. I hope someone found this helpful or interesting.